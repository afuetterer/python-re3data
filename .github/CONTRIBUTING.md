...
python-re3data could always use more documentation, whether as part of the official python-re3data docs, in docstrings,
...
3. The pull request should work for Python >= 3.10. Check https://github.com/afuetterer/python-re3data/pulls
